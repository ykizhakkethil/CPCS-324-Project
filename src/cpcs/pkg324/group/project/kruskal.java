...
public class kruskal {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (Scanner inputFile = new Scanner(new File("input1.txt"))) { // Checking if the file exists before
                                                                        // starting...
            // Number of vertices
            n = inputFile.nextInt();
            // Number of edges
        ...
        ArrayList<Edge> mst = kruskal(edges, weights, n); // Calling kruskal() method to construct the mst(minimum
                                                          // spanning tree).
        ...
        System.out.println();
        System.out.println(
                "Running Time of Kruskal’s algorithm using Union-Find approach is " + totalTime + " Nano seconds.");
    }

    // Returns the minimum spanning tree.
    public static ArrayList<Edge> kruskal(ArrayList<Edge> edges, Stack<Double> weights, int n) { // n = number of
                                                                                                 // vertices
         ...
         *
         * For every edge we have, we will check the two vertices that are connected
         * through that edge.
         * Whether they are part of the same subset or not.
         * If they are part of the same subset then we will do nothing.
         * Otherwise, we will union those vertices to the same subset. Then, add them to
         * the minimum spanning tree array.
